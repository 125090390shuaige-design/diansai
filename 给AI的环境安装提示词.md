...
- 安装后运行以下验证：
  ...
  - 对 esp32_cam_recorder.py 执行 python -m py_compile，必须无错误。
...
- 检查“启动录像工具.bat”和 esp32_cam_recorder.py 位于同一目录。
...
- 计算 CameraWebServer_STA_0x0.bin 的 SHA-256，预期为：
  561AEE1640ACBE2E30505281CE1F156E5387A5F1995C174A7AE7F92859295D8F
- 如果开发板已经烧录该版本，不要重复烧录。
- 如果需要烧录，使用仓库中的 flash_download_tool_3.9.7.exe 和旁边的 configure 目录：
  - ChipType：ESP32-S3
  - WorkMode：Develop
